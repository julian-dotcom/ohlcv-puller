...
if __name__ == "__main__":
    ...
    #     {"category": "spot", "symbol": "YFIBUSD"},
    #     {"category": "spot", "symbol": "ZECBUSD"},
    #     {"category": "spot", "symbol": "ZRXBUSD"},
    # ]
